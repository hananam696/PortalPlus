    ...
    return (
      <div className="min-h-screen bg-slate-50 px-6 py-16">
        <div className="max-w-3xl mx-auto bg-white border rounded-3xl p-10 shadow-sm text-center">
          <div className="w-16 h-16 mx-auto rounded-2xl bg-emerald-50 flex items-center justify-center border border-emerald-100">
          ...
          <p className="text-slate-600 mt-3 leading-relaxed">
            ...
            into the database and appear automatically in the Books list.
          </p>

          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/rental-hub/books"
              className="px-6 py-3 rounded-2xl bg-emerald-600 text-white font-bold hover:bg-emerald-700 transition"
            >
              View Books List
            </Link>
          ...
          <div className="mt-10 text-left rounded-3xl bg-slate-50 border p-6">
            ...
            <div className="mt-4 flex gap-5">
              <img
                src={coverPreview}
                alt={title}
                className="w-24 h-32 object-cover rounded-2xl border"
              />

              <div>
                <p className="font-extrabold text-slate-900">{title}</p>
                <p className="text-sm text-slate-600 mt-1">{author}</p>
        ...
        <div className="mt-6 bg-white rounded-3xl border shadow-sm overflow-hidden">
          <div className="p-8 md:p-10">
            ...
            <p className="text-slate-600 mt-2 max-w-2xl">
              List a textbook so other UDST students can rent or buy it. This is
              demo UI now — backend will be connected later.
            </p>
            ...
            <div className="mt-8 rounded-3xl border bg-slate-50 p-6 flex flex-col sm:flex-row gap-5">
              <img
                src={coverPreview}
                alt="Preview"
                className="w-28 h-36 object-cover rounded-2xl border bg-white"
              />
            ...
            <form onSubmit={handleSubmit} className="mt-10 grid gap-6">
              ...
              <div>
                ...
                <div className="rounded-3xl border bg-white p-6">
                  <div className="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between">
                    ...
                    <label className="inline-flex items-center justify-center px-5 py-3 rounded-2xl bg-emerald-600 text-white font-extrabold hover:bg-emerald-700 transition cursor-pointer">
                      Choose File
                      <input
                        type="file"
                        accept="image/*"
                        ...
                        onChange={(e) => {
                          ...
                          if (!file) return;
                          setCoverFile(file);
                          setCoverUrl(""); // if upload chosen, clear URL
                        }}
                      />
                    </label>
                  </div>
              ...
              >
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setCoverFile(null); // if URL used, clear upload
                  }}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  placeholder="Example: Slightly highlighted but clean. Great for IT220."
                  className="w-full rounded-2xl border px-5 py-4 bg-white text-slate-800 resize-none focus:outline-none focus:ring-2 focus:ring-emerald-600"
                />
              </div>
